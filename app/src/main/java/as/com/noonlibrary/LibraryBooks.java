...
public class LibraryBooks extends Fragment {
    ...
    private void dataSource1() {
        ...
        al.add( new Initialiser(namesStore.getBook1(),"Grade I",namesStore.getBid1(),R.drawable.c,prefs.getInt(""+namesStore.getBid1(),10)));
        al.add( new Initialiser(namesStore.getBook2(),"Grade II",namesStore.getBid2(),R.drawable.arduino,prefs.getInt(""+namesStore.getBid2(),10)));
        al.add( new Initialiser(namesStore.getBook3(),"Grade III",namesStore.getBid3(),R.drawable.cpp,prefs.getInt(""+namesStore.getBid3(),10)));
        al.add( new Initialiser(namesStore.getBook4(),"Grade IV",namesStore.getBid4(),R.drawable.ds,prefs.getInt(""+namesStore.getBid4(),10)));
        al.add( new Initialiser(namesStore.getBook5(),"Grade V",namesStore.getBid5(),R.drawable.java,prefs.getInt(""+namesStore.getBid5(),10)));
        al.add( new Initialiser(namesStore.getBook6(),"Grade VI",namesStore.getBid6(),R.drawable.os,prefs.getInt(""+namesStore.getBid6(),10)));
        al.add( new Initialiser(namesStore.getBook7(),"Grade VII",namesStore.getBid7(),R.drawable.python,prefs.getInt(""+namesStore.getBid7(),10)));
        al.add( new Initialiser(namesStore.getBook8(),"Grade VIII",namesStore.getBid8(),R.drawable.algo,prefs.getInt(""+namesStore.getBid8(),10)));
